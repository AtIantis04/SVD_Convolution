...
int main(int argc, char** argv) {
    ...
    // 1. CARGAR IMAGEN
    string imagePath = (argc > 1) ? argv[1] : "baboon.png";
    ...
    cout << "Imagen cargada: " << image.cols << "x" << image.rows << " pixeles" << endl;
    ...
    if (mse > 0) {
        ...
        cout << "Infinito (imágenes identicas)" << endl;
    }
    cout << endl;
    ...
    cout << "Reducción teorica: " << fixed << setprecision(2)
